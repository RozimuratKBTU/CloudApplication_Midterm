...
# app = Flask(__name__)
#
# # Хранилище встреч (в памяти)
# meetings = []
#
# # URL Cloud Function — замени на свой реальный
# NOTIFY_FUNCTION_URL = 'http://127.0.0.1:8080/'
#
#
# def send_notification(title, date, time, description):
#     data = {
...
#     }
#     try:
#         # requests автоматически ставит Content-Type: application/json
#         requests.post(NOTIFY_FUNCTION_URL, json=data)
#     except Exception as e:
#         print(f'❌ Ошибка при отправке уведомления: {e}')
#
...
#     return redirect(url_for('index'))
#
# CLOUD_FUNCTION_URL = "https://us-central1-polar-ray-475006-i4.cloudfunctions.net/greet_user"
#
# @app.route('/api/greet', methods=['POST'])
# def greet():
#     data = request.json
#     resp = requests.post(CLOUD_FUNCTION_URL, json=data)
